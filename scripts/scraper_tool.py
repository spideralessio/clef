...
class DownloadPageTool(BaseTool):
    ...
    def _run(
        ...
        **kwargs: Any,
        ...
        # body_html = str(soup.body)  # Now without <script> tags
        # body_html = str(soup.body)  # includes <body>...</body>
        # or, if you want only the inner content without <body> tags:
        # return body_html
        ...
        # Modify all links to include URL in text
